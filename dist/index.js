...
io.on("connection", (socket) => {
    console.log("New connection, userID: ", socket.userID);
    socket.join(socket.userSocketID);
    socket.emit("session", {
        sessionID: socket.sessionID,
    });
    socket.on("sendMessage", (_a) => __awaiter(void 0, [_a], void 0, function* ({ senderID, receiverID, chatID, text, senderName, }) {
        ...
        jsonwebtoken_1.default.verify(token, process.env.ACCESS_TOKEN_SECRET, (err, decoded) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (decoded && decoded.ID === senderID) {
                ...
                if (tokens) {
                    const messages = (0, notifications_1.createMessages)(tokens, text, chatID, senderName);
