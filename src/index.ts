...
import { createMessages, getPushTokens, sendNotifications } from "./notifications";
import { JWT, SessionSocket } from "./types";
...
io.on("connection", (socket) => {
    console.log("New connection, userID: ", (socket as SessionSocket).userID);
